...
public :
   ...
   Int_t           nrefTrk;
   Int_t           refTrkJetId [500];
   Int_t           refTrkSta [500];
   Float_t         refTrkEta [500];
   Float_t         refTrkPhi [500];
   Float_t         refTrkPt [500];
   Int_t           refTrkPdgId [500];
   Int_t           HLT_HIAK4PFJet80_v1;   //[nref]
   Int_t           HLT_HIAK4PFJet100_v1;   //[nref]
   Int_t           HLT_HIAK4PFJet40_v1;   //[nref]
   Int_t           HLT_HIAK4PFJet60_v1;   //[nref]
   Float_t         trkBdtScore[500];
   Float_t         jteta[500];   //[nref]
   TString         jer_opt[500];
   Float_t         jer_sf_up[500];
   Float_t         jer_sf_down[500];
   Float_t         jer_sf_nom[500];
...
//    tree = (TTree*) fin->Get("ak4PFJetAnalyzer/t");
   tree = (TTree*) fin->Get("akCs4PFJetAnalyzer/t");
...
void tTree::Init(TTree *tree)
{
   ...
   tree->SetBranchAddress("jer_opt", jer_opt, &b_jer_opt);
   ...
   tree->SetBranchAddress("rsjt1E", rsjt1E, &b_rsjt1E);
   ...
   tree->SetBranchAddress("rsjt2E", rsjt2E, &b_rsjt2E);
